...
// CS0, but the SAME physical SD0/SD1/SCK lines - see tt_um_abadmcu.v for
// how those get shared between this module and the flash reader. That
// sharing relies on tt8_core never asserting imem_valid and dmem_valid
...
module qspi_psram_ctrl #(
    ...
    // tt8_core-facing side (matches tt8_core's dmem_* ports, minus the
    // peripheral window - that's still decoded/handled on-chip in
    // tt_um_abadmcu.v, only non-peripheral DMEM addresses reach here)
    input  wire [7:0]  addr,
