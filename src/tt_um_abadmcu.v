...
module tt_um_abadmcu (
    ...
    // real arbitration - only because tt8_core never asserts imem_valid
    // and dmem_valid in the same cycle (S_FETCH_*/S_FETCH_GAP vs S_MEM
    // are separate, sequential FSM states in tt8_core.v). If the core
